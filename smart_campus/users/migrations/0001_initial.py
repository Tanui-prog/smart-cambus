    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('security_officer', 'Security Officer'), ('supervisor', 'Supervisor'), ('operator', 'Operator'), ('viewer', 'Viewer')], default='viewer', max_length=20, verbose_name='Role')),
                ...
                ('is_active_duty', models.BooleanField(default=False, verbose_name='Active Duty')),
